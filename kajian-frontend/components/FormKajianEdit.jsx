...
export default function FormKajianEdit({ kajian, session, ustadzList }) {
    const router = useRouter();
    const [previewFoto, setPreviewFoto] = useState(null);
    const [form, setForm] = useState({
        judul: kajian.judul || '',
        tanggal_waktu: formatDateForInput(kajian.tanggal_waktu) || '',
        lokasi: kajian.lokasi || '',
        link_lokasi: kajian.link_lokasi || '',
        materi: kajian.materi || '',
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_BASE}/api/kajian/${kajian.id}`, {
                method: 'PUT',
                headers: {
            ...
            if (res.ok) {
                handleSuccess('Kajian berhasil dirubah!');
                handleLoading(false);
        ...
        <>
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                    ...
                    {kajian.banner && (
                        <div className="mb-2">
                            <p className="text-sm text-gray-600 mb-1">Banner saat ini:</p>
                            <Image
